...
class VehicleWorkshop(GLViewportMixin, GUIWorkshop): #vers 3
    ...
    def __init__(self, main_window=None, parent=None): #TODO bugged, appears in its own window outisde the model app
        super().__init__(parent)
        self.main_window = main_window
        ...
        #to load these config files, when docked the paths to the data folder from DAT_Browser.
        #Otherwise a load button in each of the tabs for handling.cfg, carcols.dat, carmods.dat
